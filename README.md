# stepper-ninja
An open-source, free step/generator and quadrature encoder interface for LinuxCNC using raspberry pico.
...
- **Software**:
  - 1-8 PIO step generators and or quadrature encoders
