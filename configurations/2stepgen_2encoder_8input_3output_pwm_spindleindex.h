...
#define CONFIG_H
    ...
    #define stepgens 2
    #define step_invert ((const uint8_t[]){0, 0}) // step pin invert for each stepgen (0 = not inverted, 1 = inverted)
    ...
    #define encoders 2  // added 2 extra inputs

    #define spindle_encoder_index_GPIO 4  // set to negative when not used
    #define spindle_encoder_active_level high

    #define in_pins {4, 5, 6, 7, 22, 26, 27, 28} // Free GPIO pins for inputs (GPIO 22-28)
    #define in_pins_no 8
